---
# =============================================================================
#  Everything on the main page of the Insights LLC website.
#
#  This part (between the two rows of dashes) is a list of short settings,
#  one per line, in the form  name: value
#  Change what comes after the colon; leave the name and the colon alone.
#
#  The longer passages of writing come after this section, further down.
#
#  After editing, the website is rebuilt from this file — see README.md.
# =============================================================================
...
card_two_title: Leadership & Organizational Consulting
card_two_image: images/rocks.jpg
card_two_alt: Smooth beach stones of many colours resting together
...
phone: 215-839-8162
# The phone number again, in the form a mobile needs in order to dial it.
phone_dial: +12158398162
---

<!--
  Below are the longer passages. Each one begins with a heading like

      ## Welcome

  Keep those headings exactly as they are — the website is assembled from
  them — and change only the writing underneath.

  A blank line starts a new paragraph. **Text in double asterisks** comes out
  bold, *single asterisks* italic, and a line starting with "- " becomes a
  bullet point. [Words in square brackets](https://example.com) become a link.
-->
...
- **In interfaith relationships,** who find it valuable to explore what practices or traditions are important to hold onto and what is challenging to let go of;
- **Elders,** with many life stories and relationships to reflect upon, treasure, reconcile and/or heal;
- **In moments of transition or struggle,** seeking to anchor themselves and explore paths to inner strength and resilience;
